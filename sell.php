    ...
    <main>
        ...
        <div class="d-flex justify-content-center">
            <form action="" method="post" enctype="multipart/form-data" class="w-50">
                ...
                <div class="row pt-2">
                    <div class="col">
                        <?php inputElement("<i class='fas fa-award'></i>", "Booktype eg.fiction,horror etc", "book_publisher", ""); ?>
                    </div>
                    <div class="col">
        ...
        <!-- BACK BUTTON -->
        <div class=backutton>
            <a href="home.php"><i class='fas fa-arrow-circle-left' style='font-size:48px;color:black'></i></a>
        </div>
        <!-- Bootstrap table  -->
